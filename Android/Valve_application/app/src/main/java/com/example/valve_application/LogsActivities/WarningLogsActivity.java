...
public class WarningLogsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warning_logs);

        returnButton = findViewById(R.id.returnButton);

        textView = (TextView) findViewById(R.id.warningLogsTextView);
